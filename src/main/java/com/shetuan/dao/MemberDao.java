...
public class MemberDao extends BaseDao {
	...
	public Member getMemberByName(String loginname) {
		...
		try {
			...
			getCon();
			//要执行的SQL
			String sql = "select l.login_name,m.member_name,m.member_gender,l.manager_id,m.member_grade,m.member_institute,m.member_add,m.member_phone,m.member_email,c.community_name FROM member as m,login as l,community as c where m.login_name=l.login_name and  m.join_communityId=c.community_id and l.login_name=?";
			//执行查询，并传入参数：登录名
