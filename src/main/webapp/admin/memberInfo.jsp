  ...
  <tr>
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0" id="main-tab">
      ...
      <tr>
        ...
        <td align="left" valign="middle" class="borderright borderbottom main-for" onMouseOut="this.style.backgroundColor='#ffffff'" onMouseOver="this.style.backgroundColor='#edf5ff'">
          <input type="text" readonly="true" name="memberName" value="${member.memberName }" class="text-word">
        </td>
      </tr>
        ...
        <td align="left" valign="middle" class="borderright borderbottom main-for" onMouseOut="this.style.backgroundColor='#ffffff'" onMouseOver="this.style.backgroundColor='#edf5ff'">
            <input type="text" readonly="true" name="memberGender" value="${member.memberGender }" class="text-word">
        </td>

        <td align="right" valign="middle" class="borderright borderbottom bggray">寝室：</td>
        <td align="left" valign="middle" class="borderright borderbottom main-for" onMouseOut="this.style.backgroundColor='#ffffff'" onMouseOver="this.style.backgroundColor='#edf5ff'">
          <input type="text" readonly="true" name="memberAdd" value="${member.memberAdd }" class="text-word">
        </td>
        </tr>
        ...
        <td align="left" valign="middle" class="borderright borderbottom main-for" onMouseOut="this.style.backgroundColor='#ffffff'" onMouseOver="this.style.backgroundColor='#edf5ff'">
          <input type="text" readonly="true" name="memberGrade" value="${member.memberGrade }" class="text-word">
        </td>

        <td align="right" valign="middle" class="borderright borderbottom bggray">学院：</td>
        <td align="left" valign="middle" class="borderright borderbottom main-for" onMouseOut="this.style.backgroundColor='#ffffff'" onMouseOver="this.style.backgroundColor='#edf5ff'">
          <input type="text" readonly="true" name="memberInstitute" value="${member.memberInstitute }" class="text-word">
        </td>
        </tr>
        ...
        <td align="left" valign="middle" class="borderright borderbottom main-for" onMouseOut="this.style.backgroundColor='#ffffff'" onMouseOver="this.style.backgroundColor='#edf5ff'">
          <input type="text" name="memberEmail" value="${member.memberEmail }" class="text-word">
        </td>

        <td align="right" valign="middle" class="borderright borderbottom bggray">联系方式：</td>
        <td align="left" valign="middle" class="borderright borderbottom main-for" onMouseOut="this.style.backgroundColor='#ffffff'" onMouseOver="this.style.backgroundColor='#edf5ff'">
          <input type="text" name="memberPhone" value="${member.memberPhone }" class="text-word">
        </td>
        </tr>
        ...
        <td align="left" valign="middle" class="borderright borderbottom main-for" onMouseOut="this.style.backgroundColor='#ffffff'" onMouseOver="this.style.backgroundColor='#edf5ff'">
          <input type="text" readonly="true" name="jcom" value="${member.joinCommunity }" class="text-word">
        </td>
        </tr>
      ...
      <tr>
        <td align="center" valign="middle" class="borderright borderbottom main-for" colspan="3" style="padding-left:20%; border-right:none;">
        ...
        <td align="center" valign="middle" class="borderright borderbottom main-for" colspan="3" style="padding-right:20%; border-right:none;">
          <input name="" type="button" value="返回" class="text-but" onclick="location.href='javascript:history.go(-1);'">
        </td>
      </tr>
