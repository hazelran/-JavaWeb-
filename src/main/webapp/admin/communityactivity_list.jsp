  ...
  <tr>
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0" id="search">
  		<tr>
  		  ...
  		  <td width="10%" align="center" valign="middle" style="text-align:right; width:150px;"><a href="activity_add.jsp" target="mainFrame" onFocus="this.blur()" class="add">添加社团活动</a></td>
  		</tr>
	</table>
    </td>
  </tr>
