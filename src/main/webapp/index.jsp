					...
					<div class="row">
						...
						<div class="col-sm-6 col-xs-6">
							<div class="serv-img-details slideanim">
								<h4><a href="error.jsp" target="_blank">化学与社会协会</a></h4>
								<p>化学与社会协会</p>
							</div>
						</div>	
					</div>	
			...
			<div class="col-lg-6 col-md-6">
				<div class="serv-details">
					<div class="row">
						...
						<div class="col-sm-6 col-xs-6">
							<div class="serv-img-details slideanim">
								<h4><a href="error.jsp" target="_blank">天文地理协会</a></h4>
								<p>天文地理协会</p>
							</div>
						</div>
					</div>
			...
			<div class="col-lg-6 col-md-6">
				<div class="serv-details">
					<div class="row">
						...
						<div class="col-sm-6 col-xs-6">		
							<div class="serv-img-details slideanim">
								<h4><a href="error.jsp" target="_blank">数学应用协会</a></h4>
								<p>数学应用协会</p>
							</div>
						</div>
					</div>
			...
			<div class="col-lg-6 col-md-6">
				<div class="serv-details">
					<div class="row">
						...
						<div class="col-sm-6 col-xs-6">
							<div class="serv-img-details slideanim">
								<h4><a href="error.jsp" target="_blank">计算机协会</a></h4>
								<p>计算机协会</p>
							</div>
						</div>
					</div>
			...
			<div class="col-lg-6 col-md-6">
				<div class="serv-details">
					<div class="row">
						...
						<div class="col-sm-6 col-xs-6">
							<div class="serv-img-details slideanim">
								<h4><a href="error.jsp" target="_blank">English.net 协会</a></h4>
								<p>English.net 协会</p>
							</div>
						</div>	
					</div>	
			...
			<div class="col-lg-6 col-md-6">
				<div class="serv-details">
					<div class="row">
						...
						<div class="col-sm-6 col-xs-6">		
							<div class="serv-img-details slideanim">
								<h4><a href="error.jsp" target="_blank">心里学社</a></h4>
								<p>心里学社</p>
							</div>
						</div>
					</div>
			...
			<div class="col-lg-6 col-md-6">
				<div class="serv-details">
					<div class="row">
						...
						<div class="col-sm-6 col-xs-6">
							<div class="serv-img-details slideanim">
								<h4><a href="error.jsp" target="_blank">社会调查服务中心协会</a></h4>
								<p>社会调查服务中心协会</p>
							</div>
						</div>	
					</div>	
			...
			<div class="col-lg-6 col-md-6">
				<div class="serv-details">
					<div class="row">
						...
						<div class="col-sm-6 col-xs-6">
							<div class="serv-img-details slideanim">
								<h4><a href="error.jsp" target="_blank">阳光公益社</a></h4>
								<p>阳光公益社</p>
							</div>
						</div>
					</div>
			...
			<div class="col-lg-6 col-md-6">
				<div class="serv-details">
					<div class="row">
						...
						<div class="col-sm-6 col-xs-6">		
							<div class="serv-img-details slideanim">
								<h4><a href="error.jsp" target="_blank">阳光教育协会</a></h4>
								<p>阳光教育协会</p>
							</div>
						</div>
					</div>
			...
			<div class="col-lg-6 col-md-6">
				<div class="serv-details">
					<div class="row">
						...
						<div class="col-sm-6 col-xs-6">
							<div class="serv-img-details slideanim">
								<h4><a href="error.jsp" target="_blank">三元学社</a></h4>
								<p>三元学社</p>
							</div>
						</div>	
					</div>	
			...
			<div class="col-lg-6 col-md-6">
				<div class="serv-details">
					<div class="row">
						...
						<div class="col-sm-6 col-xs-6">
							<div class="serv-img-details slideanim">
								<h4><a href="error.jsp" target="_blank">争鸣社</a></h4>
								<p>争鸣社</p>
							</div>
						</div>
					</div>
			...
			<div class="col-lg-6 col-md-6">
				<div class="serv-details">
					<div class="row">
						...
						<div class="col-sm-6 col-xs-6">
							<div class="serv-img-details slideanim">
								<h4><a href="error.jsp" target="_blank">健身协会</a></h4>
								<p>健身协会</p>
							</div>
						</div>	
					</div>	
			...
			<div class="col-lg-6 col-md-6">
				<div class="serv-details">
					<div class="row">
						...
						<div class="col-sm-6 col-xs-6">
							<div class="serv-img-details slideanim">
								<h4><a href="error.jsp" target="_blank">魔术协会</a></h4>
								<p>魔术协会</p>
							</div>
						</div>
					</div>
			...
			<div class="col-lg-6 col-md-6">
				<div class="serv-details">
					<div class="row">
						...
						<div class="col-sm-6 col-xs-6">		
							<div class="serv-img-details slideanim">
								<h4><a href="error.jsp" target="_blank">排球协会</a></h4>
								<p>排球协会</p>
							</div>
						</div>
					</div>
			...
			<div class="col-lg-6 col-md-6">
				<div class="serv-details">
					<div class="row">
						...
						<div class="col-sm-6 col-xs-6">
							<div class="serv-img-details slideanim">
								<h4><a href="error.jsp" target="_blank">乒乓球协会</a></h4>
								<p>乒乓球协会</p>
							</div>
						</div>
					</div>
...
<div id="container">
    <ul class="noticeList">
        <li><a href="info/activityDetil.jsp" title=""  target="_Blank">创业协会2021.5.25创客空间活动室   :针对“大众创新万众创业”活动开展相应培训</a></li>
        <li><a href="info/activityDetil.jsp" title="" target="_blank">计算机协会2021.11.6计算机科研室    :举办大学生“Oracl"甲骨文ACM竞赛</a></li>
        <li><a href="info/activityDetil.jsp" title="" target="_blank">天文地理协会 2012.10.9教学楼103 :"走进天文，探索奥秘"主题活动，讲解天体观测</a></li>
        <li><a href="info/activityDetil.jsp" title="" target="_blank">数学应用协会 2020.5.6  教学楼505 :数学课堂知识模拟大赛</a></li>
        ...
        <li><a href="info/activityDetil.jsp" title="" target="_blank">阳光公益社	2018.4.28  幸福中心小学  :深入课堂，走进学生身边开展支教活动 </a></li>
        <li><a href="info/activityDetil.jsp" title="" target="_blank">健身协会  2020.5.6  体育馆健身馆	:普及健康知识，进行健身动作讲解</a></li>
